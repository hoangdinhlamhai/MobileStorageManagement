...
public class CartDetailController {
    ...
    @PostMapping
    public ResponseEntity<CartDetail> create(@RequestBody CartDetailRequestDTO cartDetailDTO) {
        System.out.println(
                "Received cartId=" + cartDetailDTO.getCartId() + ", productId=" + cartDetailDTO.getProductId());
